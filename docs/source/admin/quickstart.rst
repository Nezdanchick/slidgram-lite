...
slidgram uses the `Jabber Component Protocol <https://xmpp.org/extensions/xep-0114.html>`_ to
...
Next, you probably want to set up :ref:`attachments <attachments>` to support bridging files from Telegram to XMPP.
